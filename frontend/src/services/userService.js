...
// Get user details
const profile = async (data, token) => { // Pegar o perfil do usuário logado pelo token dele e retorna o usuário para ser exibido na página.
    const config = requestConfig("GET", data, token) // para extrair dados.
